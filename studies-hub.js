(function(){
  ...
  const journeyCollections=[
    ...
    {id:'leadership',icon:'🧭',title:'Leadership',eyebrow:'Serve and equip',description:'Formed by Christ. Serving with integrity. Equipping others through character, service, wisdom, healthy teams, accountability, endurance, and multiplication.',meta:'10 of 10 studies available',status:'available',href:'leadership.html',action:'Open Complete Journey'},
