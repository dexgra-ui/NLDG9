...
const audiences={
 family:{label:'Familia',sourceQuestionCount:20,entries:familyEntries},
 preschool:{label:'Preescolar',sourceQuestionCount:20,entries:preschoolEntries}
};
...
window.NLDG_ES_FINISH_VERSE={
 translation:'NTV',reviewedAudiences:['family','preschool'],audiences,referenceBooks,
