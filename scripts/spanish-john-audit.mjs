...
if(required.every(exists)){
 ...
 if(!l5.teaching[0].body.includes('no es fórmula')||!l5.teaching[2].body.includes('no es falta de fe')||!l5.teaching[5].body.includes('no excusa'))errors.push('Lesson 5 must preserve unanswered-prayer, grief, and justice safeguards.');
