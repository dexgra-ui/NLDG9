...
if(!errors.length){
 ...
 const safeguards=[
  ...
  ['Psalm 91 not immunity',['sin crear un contrato de inmunidad','no garantiza inmunidad contra enfermedad, accidente, persecución, violencia o muerte']],
  ...
  ['forgiveness and accountability',['El perdón no restaura automáticamente confianza, acceso, cargo o seguridad','no exige reconciliación inmediata de una persona herida']],
  ...
  ['Psalm 137 trauma not violence',['no es mandato para que el pueblo de Dios mate niños o ataque una etnia','no autoriza hacer daño a niños']],
  ['lawful justice',['justicia por medios veraces, legales y protectores','preserva evidencia']],
  ['Psalm 37 not poverty blame',['no debe transformarse en regla universal de que la pobreza prueba pecado','«deseos de tu corazón» no es un cheque en blanco']],
  ['Psalm 121 not accident proof',['no contrato de viaje sin accidentes','planes de seguridad no contradicen el salmo']],
  ['unity not cover up',['La unidad bíblica no puede significar uniformidad, encubrimiento','no uses Salmo 133 para exigir silencio']],
  ...
  ['praise not forced happiness',['no es negación del lamento','No conviertas Salmo 150 en mandato de que personas en duelo siempre deben sonar celebratorias']]
 ];
