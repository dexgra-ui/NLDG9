...
const writings=[
  ...
  {id:'jannes-jambres',title:'Jannes and Jambres tradition',url:'ancient-writing-jannes-jambres.html',passages:['Exodus 7-8','2 Timothy 3:8-9'],relationship:'ancient tradition',canonicalStudies:[{label:'Exodus',url:'exodus-study.html'},{label:'2 Timothy',url:'second-timothy-study.html'}]},
  {id:'book-jashar',title:'Book of Jashar',url:'ancient-writing-jashar.html',passages:['Joshua 10:12-13','2 Samuel 1:17-27','Numbers 21:14'],relationship:'named source',canonicalStudies:[{label:'Joshua',url:'joshua-study.html'},{label:'2 Samuel',url:'second-samuel-study.html'},{label:'Numbers',url:'numbers-study.html'}]},
  {id:'wars-of-lord',title:'Book of the Wars of the Lord',url:'ancient-writing-wars-of-lord.html',passages:['Numbers 21:13-15','Numbers 21:17-18 (possible)','Exodus 17:14 (possible)'],relationship:'named source',canonicalStudies:[{label:'Numbers',url:'numbers-study.html'},{label:'Exodus',url:'exodus-study.html'}]},
  {id:'nathan-gad',title:'Records of Nathan and Gad',url:'ancient-writing-nathan-gad.html',passages:['1 Chronicles 29:29-30','2 Chronicles 9:29','2 Chronicles 29:25'],relationship:'named records',canonicalStudies:[{label:'1 Chronicles',url:'first-chronicles-study.html'},{label:'2 Chronicles',url:'second-chronicles-study.html'},{label:'2 Samuel',url:'second-samuel-study.html'}]},
  {id:'royal-chronicles',title:'Royal chronicles and named records',url:'ancient-writing-royal-chronicles.html',passages:['1 Kings 11:41','1 Kings 14:19','1 Kings 14:29','2 Kings 14:15-18','2 Chronicles 16:11','2 Chronicles 24:27'],relationship:'named records',canonicalStudies:[{label:'1 Kings',url:'first-kings-study.html'},{label:'2 Kings',url:'second-kings-study.html'},{label:'2 Chronicles',url:'second-chronicles-study.html'}]}
];
