(()=>{
const writings=[
  {id:'1-enoch',title:'1 Enoch',url:'other-ancient-writings.html#1-enoch',passages:['Jude 14–15'],relationship:'direct quotation',canonicalStudies:[{label:'Jude',url:'jude-study.html'}]},
