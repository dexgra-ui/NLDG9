...
async function staticChecks(){
  ...
  record(serviceWorker.includes("const CACHE='nldg-v1-1-0'")&&serviceWorker.includes("'index.html'")&&serviceWorker.includes("'styles.css'")&&serviceWorker.includes("'script.js'")&&serviceWorker.includes("'site-navigation.js'"),'Version 1.1 offline shell uses a stable release cache with essential application files.','Service worker release cache or essential application-shell files are missing.');
