const CACHE='nldg-v5-shell';
const CORE=['./','index.html','styles.css','platform.css','content-library.js','script.js','personalization.js','dashboard.html','dashboard.css','dashboard.js','resource-center.html','search.html','studies.html','play.html','no-labels-approved-logo.png','manifest.webmanifest'];
