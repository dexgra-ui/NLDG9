(function(){
  ...
  const journeyCollections=[
    ...
    {id:'women-of-faith',icon:'🌸',title:'Women of Faith',eyebrow:'Women’s discipleship',description:'Known by God. Growing in grace. Walking together through identity, dignity, hard seasons, healthy dependence, healing, community, calling, and service.',meta:'5 of 10 studies available',status:'available',href:'women-of-faith.html',action:'Continue the Journey'},
