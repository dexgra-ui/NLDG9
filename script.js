...
navigationScript.src='site-navigation.js?v=1.5.0';
...
(function platformIntegration(){
  ...
  const ensureLibrary=()=>new Promise((resolve,reject)=>{if(window.NLDG_LIBRARY){resolve();return;}const script=document.createElement('script');script.src='content-library.js?v=20260728-4';script.onload=resolve;script.onerror=reject;document.head.appendChild(script);});
...
(function sprintFiveBootstrap(){
  ...
  if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('sw.js?v=5.7.0').catch(()=>{}));
  let installPrompt;
