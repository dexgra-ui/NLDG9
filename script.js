...
(function platformIntegration(){
  ...
  const ensureLibrary=()=>loadScript('content-library.js?v=20260920-8',()=>Boolean(window.NLDG_LIBRARY)).then(()=>loadScript('marriage-family-library.js?v=1.0.0',()=>Boolean(window.NLDG_MARRIAGE_FAMILY_LIBRARY_LOADED))).then(()=>loadScript('difficult-questions-library.js?v=1.0.0',()=>Boolean(window.NLDG_DIFFICULT_QUESTIONS_LIBRARY_LOADED))).then(()=>loadScript('leadership-library.js?v=1.0.0',()=>Boolean(window.NLDG_LEADERSHIP_LIBRARY_LOADED))).then(()=>loadScript('devotional-library.js?v=1.3.0',()=>Boolean(window.NLDG_DEVOTIONAL_LIBRARY_LOADED))).then(()=>loadScript('article-library.js?v=1.0.0',()=>Boolean(window.NLDG_ARTICLE_LIBRARY_LOADED))).then(()=>loadScript('contact-library.js?v=1.0.0',()=>Boolean(window.NLDG_CONTACT_LIBRARY_LOADED)));
