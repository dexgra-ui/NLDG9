...
if(!errors.length){
 ...
 const safeguards=[
  ...
  ['survivor dignity',['no hacer personalmente responsable a cada víctima','no culpes sobrevivientes individuales por catástrofe']],
  ...
  ['Edom not modern code',['La burla de Edom es juzgada sin autorizar odio étnico','no uses Edom como código para un grupo moderno']],
