...
if(!errors.length){
  ...
  if(!l6.teaching[2].body.includes('enfermedad o desastre prueba culpa personal')||!l6.teaching[4].body.includes('no posee poder independiente')||!l6.teaching[5].body.includes('convertirse en ídolo'))fail('Lesson 6 must preserve illness dignity, non-magical healing, and anti-idolatry safeguards.');
