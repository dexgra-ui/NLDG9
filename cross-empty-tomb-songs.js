(()=>{
  ...
  const songs={
    ...
    4:{title:'Because He Lives',artist:'Bill & Gloria Gaither',why:'The resurrection changes the future because Jesus is alive. The song connects the empty tomb with courage, hope, and life beyond death, fitting the lesson’s movement from resurrection to witness and mission.'}
  };
