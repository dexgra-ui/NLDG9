...
if(!errors.length){
  ...
  if(!l5.teaching[2].body.includes('atención médica')||!l5.teaching[3].body.includes('no es fórmula')||!l5.teaching[4].body.includes('enemigos étnicos o políticos modernos')||!l5.teaching[5].body.includes('agotamiento no es fidelidad'))fail('Lesson 5 must preserve material care, non-formula faith, anti-scapegoating, and sustainable leadership.');
