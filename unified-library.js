(function(){
  ...
  const favoriteSet=()=>new Set([...read(FAVORITES,[]),...read(LEGACY_FAVORITES,[])]);
  ...
  function category(item){
    ...
    if(item.type==='Faith & Truth Lesson'||item.type==='Study')return 'studies';
    ...
    if(item.type==='Article'||item.type==='News'||item.type==='Podcast')return 'articles';
