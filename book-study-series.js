(function(){
 ...
 function render(x){
  ...
  const openingPanel=s.lessonSubtitleMode?`<section class="lesson-panel"><h2>Opening</h2><p>${esc(x.opening)}</p></section>`:`<section class="lesson-panel"><p class="kicker">Lesson purpose</p><p>${esc(x.goal)}</p><h2>Opening</h2><p>${esc(x.opening)}</p></section>`;
