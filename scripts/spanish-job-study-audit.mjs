...
if(!errors.length){
 ...
 const safeguards=[
  ...
  ['humility not self hate',['sin enseñarnos desprecio propio','humildad con self-hatred']],
  ...
  ['Job 42 calamity difficulty',['El texto atribuye calamidad a Dios sin darnos una fórmula universal','no autoriza a cuidadores a decir a personas específicas que Dios causó personalmente']],
