...
const pages=['index.html','articles.html','devotionals.html',...articlePages,...devotionalPages];
...
if(exists('sitemap.xml')){
 ...
 for(const file of articlePages.concat(devotionalPages))assert(sitemap.includes(`https://nolabelsdesignedbygod.org/${file}`),`sitemap.xml: missing ${file}`);
}
