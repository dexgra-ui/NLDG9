(()=>{
  ...
  function addMaps(){
    ...
    const studyLabel=spanish?'Estudio Caminando con Jesús':'Walking With Jesus Study';
    section.querySelectorAll('.wj-map-links a').forEach(link=>wireMapLink(link,studyLabel));
    return true;
  }
