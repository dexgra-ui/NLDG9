...
if(!errors.length){
 ...
 const safeguards=[
  ...
  ['disaster blame rejected',['no afirmes que cada desastre es castigo por un pecado específico','no culpes a víctimas por tragedias']],
  ['prepare-meet context',['es una advertencia de juicio','no conviertas «prepárate para encontrarte con tu dios» en amenaza sin contexto']],
  ['justice nonpartisan',['no presiones revelación política ni digas qué partido favorece dios','autocelebración partidista']],
  ['Amos 5 textual humility',['sikkuth, kiyyun, moloc o refán','dificultad textual de amós 5:26']],
  ['comfort not automatically sinful',['confrontar comodidad sin demonizar descanso','no demonices descanso, música, arte']],
  ['Lo-debar wordplay',['lo-debar puede sonar como «nada»','karnaim']],
  ['anak uncertainty',['’anak','su material o sentido exacto es debatido']],
  ['not anti-clergy',['no ataques al clero formado','no ataques al clero formado']],
  ...
  ['famine no manipulation',['no uses este texto para decir que dios abandona a una persona','no uses el hambre de oír para manipular miedo']],
  ['Amos 9 universal sovereignty',['filisteos desde caftor','arameos desde kir']],
  ['textual variant Amos 9',['texto hebreo','tradición griega','remanente de edom','remanente de la humanidad']],
  ['Acts 15 guardrails',['inclusión de los gentiles','no autoriza antisemitismo']],
  ['political restraint',['apropiación partidista','política incuestionable']],
