...
const root=nested?'../':'';
const bookSearchIntegration=document.createElement('script');
bookSearchIntegration.src=`${root}book-search-integration.js?v=1.0.0`;
bookSearchIntegration.async=false;
document.head.appendChild(bookSearchIntegration);
