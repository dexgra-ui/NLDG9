...
navigationScript.src='site-navigation.js?v=1.6.0';
...
(function sprintFiveBootstrap(){
  ...
  if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('sw.js?v=5.8.0').catch(()=>{}));
  let installPrompt;
